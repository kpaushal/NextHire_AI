...
export const BentoGridItem = ({
    ...
    return (
        <motion.div
            ...
            onClick={onClick}
        >
            <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover/bento:opacity-100 transition-opacity" />

            <div className="relative z-10 group-hover/bento:scale-105 transition-transform duration-200">
                {header}
            </div>

            <div className="group-hover/bento:translate-x-2 transition duration-200 relative z-10">
                <div className="mb-2 mt-2 text-primary">
                    {icon}
                </div>
